...
(define make-text (lambda (str) (set-property "text-rotation" 0 (set-property "text-scale" 1 (set-property "position" (define origin (make-point 0 0)) (set-property "object-name" "text" (str)))))))
